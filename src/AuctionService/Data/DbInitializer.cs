...
namespace AuctionService.Data
{
    public class DbInitializer
    {
        ...
        {
            // Create the DB in doesn't exist and apply pending migrations
            auctionDbContext.Database.Migrate();

            if (auctionDbContext.Auctions.Any())
            {
                Console.WriteLine("Already have data in database - no need to seed");
                return;
            }


            // No auctions in the database - Seed the data
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndsAt = DateTime.UtcNow.AddDays(10),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                AuctionEndsAt = DateTime.UtcNow.AddDays(60),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEndsAt = DateTime.UtcNow.AddDays(4),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                AuctionEndsAt = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndsAt = DateTime.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionEndsAt = DateTime.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEndsAt = DateTime.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionEndsAt = DateTime.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndsAt = DateTime.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
